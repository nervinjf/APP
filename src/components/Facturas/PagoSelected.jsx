...
import ProductsSelect from './Products/ProductsSelect';
        ...
        <View style={styles.containergap}>
            ...
            <View style={styles.containerdescription}>
                ...
                <View style={styles.containerdescriptionMonto}>
                    <Text style={{ color: "gray", fontSize: 17, fontWeight: "600", textAlign: 'right'}}>$555</Text>
                    <Text style={{ color: "gray", fontSize: 17, textAlign: 'right' }}>$0.30</Text>
                    <Text style={{ color: "#7B34DC", fontSize: 17, fontWeight: "600", textAlign: 'right' }}>$585</Text>
                </View>
            </View>
